...
export const CARS = [
  {
    ...
    length: 3.9, width: 1.94, wheelSize: 0.42
  },
  {
    id: 'muscle',
    name: 'Blacktop V8',
    ...
    length: 4.6, width: 2.14, wheelSize: 0.48, spoiler: true
  },
  {
    id: 'interceptor',
    name: 'Nightline GT',
    ...
    length: 4.4, width: 2.06, wheelSize: 0.45, spoiler: true, glow: true, glowColor: 0x9d5cff
  },
  {
    id: 'admin',
    ...
    length: 4.5, width: 2.16, wheelSize: 0.47, spoiler: true, glow: true, glowColor: 0xff3ea5
  }
];
...
export const ADMIN_SCHEMA = [
  ...
  { key: 'wheelSize', label: 'Wheel Size', min: 0.26, max: 1.3, step: 0.01, fmt: v => v.toFixed(2) + ' m' },
...
export const ADMIN_PRESETS = [
  ...
  {
    name: 'ROCKET',
    values: { maxSpeed: 240, accel: 200, brake: 90, boost: 2.6, grip: 14, steerRate: 2.1, mass: 0.8, flySpeed: 170, flyLift: 70, gravity: 20, color: 0x00e5ff, glowColor: 0x00e5ff, glow: true, spoiler: true, length: 4.2, width: 2, wheelSize: 0.42 }
  },
  {
    name: 'DRIFT KING',
    values: { maxSpeed: 70, accel: 78, brake: 34, boost: 1.5, grip: 3.6, driftGrip: 0.5, steerRate: 3.4, mass: 1.4, color: 0xffcc3d, glowColor: 0xffcc3d, glow: true, spoiler: true, length: 4.6, width: 2.2, wheelSize: 0.5 }
  },
  {
    name: 'MONSTER',
    values: { maxSpeed: 60, accel: 70, brake: 60, boost: 1.4, grip: 8, steerRate: 1.8, mass: 3.4, gravity: 34, length: 6.4, width: 3.6, wheelSize: 1.15, color: 0x3ddc84, glowColor: 0x3ddc84, glow: true, spoiler: false }
  },
  {
    name: 'JET',
    values: { maxSpeed: 130, accel: 110, brake: 70, boost: 2, grip: 12, steerRate: 2.6, mass: 0.5, flySpeed: 210, flyLift: 110, gravity: 6, color: 0xe8f4ff, accentColor: 0x0a1420, glowColor: 0x37e6ff, glow: true, spoiler: true, length: 5.2, width: 2.3, wheelSize: 0.36 }
  },
  {
    name: 'GOD MODE',
    values: { maxSpeed: 300, accel: 260, brake: 160, boost: 4, grip: 26, driftGrip: 8, steerRate: 7, mass: 4, flySpeed: 220, flyLift: 120, gravity: 2, invincible: true, noPolice: true, color: 0xffffff, accentColor: 0x000000, wheelColor: 0xffcc3d, glowColor: 0xff3ea5, glow: true, spoiler: true, length: 4.8, width: 2.4, wheelSize: 0.55 }
  }
];
...
export const POLICE_SPEC = {
  ...
  brake: 30,
  steerRate: 2.0,
  length: 4.5, width: 2.1, wheelSize: 0.46
};
